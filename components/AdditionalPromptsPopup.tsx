...
export default function AdditionalPromptsPopup({
  ...
  return (
    <>
      ...
      <div className="absolute bottom-full left-0 mb-2 z-50 w-[400px] bg-[#1e1e22] border border-[#2a2a2a] rounded-xl p-5 shadow-2xl animate-fade-in">
        <div className="flex items-center justify-between mb-1">
          <h4 className="text-[15px] font-semibold text-white">Additional Prompts</h4>
          <button
            onClick={onClose}
            className="w-6 h-6 flex items-center justify-center text-[#666] hover:text-white transition-colors"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <textarea
          ...
          rows={3}
          className="w-full bg-[#141416] border border-[#2a2a2a] focus:border-[#4a90d9] rounded-lg px-3 py-2.5 text-[13px] text-white placeholder:text-[#555] focus:outline-none resize-none transition-colors mb-4"
        />
        ...
        <textarea
          ...
          rows={3}
          className="w-full bg-[#141416] border border-[#2a2a2a] focus:border-[#4a90d9] rounded-lg px-3 py-2.5 text-[13px] text-white placeholder:text-[#555] focus:outline-none resize-none transition-colors"
        />
